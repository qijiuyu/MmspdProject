...
public class CancleAdapter extends BaseAdapter {
    ...
    public CancleAdapter(Context context, List<Order.OrderBean> list) {
        super();
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        //显示当前订单说明
        OrderStatus.showShuoMing(holder.tvShuoMing,holder.tvShuoMing2,null,orderBean);
        ...
        holder.tvRefundDes.setText("取消原因："+orderBean.getCancelreason());
        ...
        holder.linGoodPlay.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                CancleAdapter.this.notifyDataSetChanged();
            }
        });
