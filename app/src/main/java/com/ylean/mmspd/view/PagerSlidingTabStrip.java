...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private Drawable selectBackgroundColor;
			...
			if (v instanceof TextView) {
				...
				if (i == selectedPosition) {
					...
					if(selectBackgroundColor!=null){
						tab.setBackground(selectBackgroundColor);
					}
				}
			}
		}
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < tabCount - 1; i++) {
			...
			canvas.drawLine(tab.getRight(), dividerPadding, 100, height - dividerPadding, dividerPaint);
		}
	}
	...
	public void setSelectBackgroundColor(int resId){
		this.selectBackgroundColor=getResources().getDrawable(resId);
		updateTabStyles();
	}
